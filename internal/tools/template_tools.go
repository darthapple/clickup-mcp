...
func RegisterTemplateTools(s *server.MCPServer, c *clickup.Client) {
	s.AddTool(
		mcp.NewTool("clickup_create_folder_from_template",
			...
			mcp.WithString("template_id", mcp.Required(), mcp.Description("Folder template ID")),
	...
	s.AddTool(
		mcp.NewTool("clickup_create_list_from_template_in_folder",
			...
			mcp.WithString("template_id", mcp.Required(), mcp.Description("List template ID")),
	...
	s.AddTool(
		mcp.NewTool("clickup_create_task_from_template",
			...
			mcp.WithString("template_id", mcp.Required(), mcp.Description("Task template ID")),
